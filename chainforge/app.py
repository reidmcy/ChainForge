...
def main():
    ...
    serve_parser.add_argument('--cache_direrctory',
                                help="The directory to store the cache files. Uses the environment variable 'CHAINFORGE_CACHE_DIR' or '~/.cache/chainforge' if not specified.",
    ...
    run_server(host=host, port=port, cmd_args=args, cache_dir=args.cache_direrctory)
